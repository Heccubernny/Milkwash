            ...
            <div class="d-table">
                <div class="d-tablecell">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <h2>Apartment Service</h2>
                            </div>
                            <div class="col-md-6">
                                <div class="cleaning-breadcumb">
                                   <a href="#">home</a> / <a href="services.php">service</a> / Apartment service
                               </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="widget recent_posts">
                            ...
                            <ul>
                                <li>
                                    <a href="apartment-service.php">Apartment Cleaning</a>
                                </li>
                                <li>
                                    <a href="office-service.php">Office Cleaning</a>
                                </li>
                                <li>
                                    <a href="house-service.php">House Cleaning</a>
                                </li>
                                <li>
                                    <a href="car-service.php">Car Washing</a>
                                </li>
                                <li>
                                    <a href="maintenance-service.php">Maintenance Service</a>
                                </li>
                            </ul>
                        </div>
