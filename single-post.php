...
<!-- Mirrored from templates.envytheme.com/milkwash/default/single-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Sep 2019 14:01:47 GMT -->
<head>
        <meta charset="UTF-8">
                            ...
                            <ul id="navigation">
                                ...
                                <li><a href="shop.html">Shop</a>
                                    <ul>
                                        ...
                                        <li><a href="shop-2.html">Shop Style 1</a></li>
                                        <li><a href="single-shop.html">Single Shop</a></li>
                                ...
                                <li class="active"><a href="blog.html">Blog</a>
                                    <ul>
                                        ...
                                        <li><a href="blog-2.html">Blog Style 1</a></li>
                                        <li class="active"><a href="single-post.html">Single Blog style 1</a></li>
                        ...
                        <div class="post-details-area">
                            ...
                            <div class="post-description">
                                <ul class="list-inline">
                                    <li><a href="#"><i class="fa fa-calendar"></i> 21 June</a></li>
                            ...
                            <div class="post-share-area">
                                <div class="row">
                                   <div class="col-md-5">
                                        <a href="#" class="read-more-btn"><i class="fa fa-arrow-circle-left"></i> Back</a>
                                    </div>
                                ...
                                <div class="comments-area">
                                    ...
                                    <ul class="comment-list">
                                        <li class="comment-item">
                                            <div class="row">
                                                <div class="col-lg-2 col-md-3">
                                                    <img class="img-circle" src="assets/img/profile-img-1.jpg" alt="Image">
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-2 col-md-3 offset-lg-2">
                                                    <img class="img-circle" src="assets/img/profile-img-3.jpg" alt="Image">
                                                </div>
                                        ...
                                        <li class="comment-item">
                                            <div class="row">
                                                <div class="col-lg-2 col-md-3">
                                                    <img class="img-circle" src="assets/img/profile-img-2.jpg" alt="Image">
                                                </div>
                                    ...
                                    <div class="comment-form-wrap">
                                        <form action="https://templates.envytheme.com/milkwash/default/single-post.html">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <p><input placeholder="Your name *" type="text" required></p>
                                                </div>
                                                <div class="col-lg-6">
                                                    <p><input placeholder="Your email *" type="text" required></p>
                                                </div>
                                            </div>

                                            <textarea placeholder="Message" name="message" id="message" cols="30" rows="10" required></textarea>
                                            <input class="sbmt-btn" value="Submit comment" type="submit">
                                        </form>
                                    </div>
...
<!-- Mirrored from templates.envytheme.com/milkwash/default/single-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Sep 2019 14:01:57 GMT -->
</html>